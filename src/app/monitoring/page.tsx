      ...
      {user ? (
        <>         
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col border rounded-lg justify-center items-center gap-2 w-full mx-auto text-sm  mt-2">
            ...
            <div className="flex border mt-4 p-2 rounded-lg flex-col  justify-center items-center gap-4">
              <p className="font-semibold text-base sm:text-xl pt-4">
                Kontrol Hidroponik
              </p>
          ...
          <div className="flex p-2 border mt-4 rounded-lg justify-center mb-4 items-center flex-col">
